            ...
            <div class="col-lg-12">
                <div class="footer__copyright">
                    <div class="footer__copyright__text"><p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                      Copyright &copy;<script>document.write(new Date().getFullYear());</script> Vendas de Sistemas | Loja Virtual  <i class="fa fa-heart" aria-hidden="true"></i> by <a class="text-info" href="https://vendassistemas.com.br/" target="_blank">contato@vendassistemas.com.br</a>
