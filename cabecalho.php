...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Venda de Código fontes de sistemas">
    <?php if(@$palavras == ""){ ?>
    <meta name="keywords" content="Sistema completo">
    <?php }else{ ?>
    ...
    <link rel="shortcut icon" href="img/logoicone2.png" type="image/x-icon">
    <link rel="icon" href="img/logoicone2.png" type="image/x-icon">
</head>
